      ...
      <nav className="fixed top-0 left-0 right-0 backdrop-blur-md border-b border-theme-secondary z-50 transition-colors duration-300" style={{ backgroundColor: `rgba(var(--bg-primary), 0.98)` }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* Right: Controls + System Overview Link */}
            <div className="flex items-center space-x-6">
              <a
                href="https://quantitative-stat.netlify.app/"
                className="hidden md:inline-block text-xs mono-accent tracking-wide text-theme-muted hover:text-theme transition-colors duration-200 border-b border-transparent hover:border-theme-muted"
              >
                ← System Overview
              </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-theme-secondary bg-theme transition-colors duration-300">
            <div className="px-4 py-2 space-y-1">
              {/* System Overview Link (Mobile) */}
              <a
                href="https://quantitative-stat.netlify.app/"
                className="block w-full text-left px-3 py-2 text-xs font-medium mono-accent text-theme-muted hover:text-theme border-l-2 border-transparent transition-colors"
              >
                ← System Overview
              </a>

              <div className="h-px bg-theme-secondary my-2"></div>
      ...
      <main className="pt-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="philosophy" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              <p className="text-base leading-relaxed mb-10 font-light text-theme-secondary transition-colors duration-300">
              ...
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">2.1 Trend Following and Market Regimes</h3>
                <p className="text-sm leading-relaxed mb-6 font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Low-Volatility Uptrend</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">Allow moderate leverage; allocate more capital to risk assets.</p>
                  </div>
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">High-Volatility Uptrend</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">Maintain exposure but reduce leverage and size.</p>
                  </div>
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Sideways/Low Volatility</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">Deploy neutral strategies or stay in cash.</p>
                  </div>
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">High-Volatility Downtrend</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">Cut exposure to risk assets and raise cash.</p>
                  </div>
                </div>
              ...
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">2.2 Risk Parity and Balanced Exposures</h3>
                <p className="text-sm leading-relaxed font-light text-theme-secondary transition-colors duration-300">
              ...
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">2.3 Relative Strength and Rotational Momentum</h3>
                <p className="text-sm leading-relaxed mb-6 font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="bg-theme-secondary border-l-2 border-theme-muted pl-6 py-4 my-6 transition-colors duration-300">
                  <p className="text-xs leading-relaxed font-light italic text-theme-secondary transition-colors duration-300">
              ...
              <div>
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">2.4 Global Liquidity as a Macro Driver</h3>
                <p className="text-sm leading-relaxed mb-6 font-light text-theme-secondary transition-colors duration-300">
          ...
          <section id="architecture" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">3.1 Overview</h3>
                <p className="text-base leading-relaxed mb-8 font-light text-theme-secondary transition-colors duration-300">
                  My system consists of two primary layers:
                </p>

                <div className="space-y-6 mb-8">
                  <div className="border-l-2 border-theme-muted pl-6 py-3 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-sm mono-accent text-theme transition-colors duration-300">Meta-Engine</h4>
                    <p className="text-sm font-light leading-relaxed text-theme-secondary transition-colors duration-300">
                  ...
                  <div className="border-l-2 border-theme-muted pl-6 py-3 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-sm mono-accent text-theme transition-colors duration-300">Decision Engine</h4>
                    <p className="text-sm font-light leading-relaxed text-theme-secondary transition-colors duration-300">
              ...
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">3.2 Signal Components</h3>
                <p className="text-sm leading-relaxed mb-8 font-light text-theme-secondary transition-colors duration-300">
                  The Decision Engine draws on a variety of signals that capture different aspects of market behaviour:
                </p>

                <div className="space-y-6">
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Trend Signals</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                  ...
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Volatility Signals</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                  ...
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Macro/Liquidity Signals</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                  ...
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Relative Strength Rankings</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                  ...
                  <div className="border border-theme-secondary p-5 research-card transition-colors duration-300">
                    <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Mean Reversion Checks</h4>
                    <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
              ...
              <div>
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">3.3 State Machine and Rotation Logic</h3>
                <p className="text-sm leading-relaxed mb-6 font-light text-theme-secondary transition-colors duration-300">
          ...
          <section id="liquidity" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              ...
              <div className="space-y-6 mb-8">
                <div className="border border-theme-secondary p-5 border-l-2 border-l-theme-muted research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">High correlation between liquidity and Bitcoin</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-5 border-l-2 border-l-theme-muted research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Liquidity drives risk appetite</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-5 border-l-2 border-l-theme-muted research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Macro signals inform risk budgets</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
          ...
          <section id="risk" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              ...
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">5.1 Volatility Targeting and Risk Parity</h3>
                <p className="text-sm leading-relaxed font-light text-theme-secondary transition-colors duration-300">
              ...
              <div className="mb-12">
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">5.2 Stress Testing and Drawdown Caps</h3>
                <p className="text-sm leading-relaxed mb-6 font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="bg-theme-secondary border border-theme-secondary p-6 transition-colors duration-300">
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
              ...
              <div>
                <h3 className="text-base font-bold mb-6 tracking-wide mono-accent text-theme transition-colors duration-300">5.3 Simple Models and Robustness</h3>
                <p className="text-sm leading-relaxed mb-6 font-light text-theme-secondary transition-colors duration-300">
          ...
          <section id="relative-strength" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              ...
              <div className="space-y-6 mb-8">
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Historical success of rotational momentum</h4>
                  <p className="leading-relaxed text-xs font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Macro momentum across assets</h4>
                  <p className="leading-relaxed text-xs font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Relative strength with trend filter</h4>
                  <p className="leading-relaxed text-xs font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Business cycle sensitivity</h4>
                  <p className="leading-relaxed text-xs font-light text-theme-secondary transition-colors duration-300">
              ...
              <div className="p-8 border-2 transition-colors duration-300" style={{ backgroundColor: "rgb(var(--bg-secondary))", borderColor: "rgb(var(--border-primary))", color: "rgb(var(--text-primary))" }}>
          ...
          <section id="value" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Rigorous Thought Process</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Modular Complexity</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Evidence-Based Strategy Selection</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Risk Discipline</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Macro Awareness</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
                ...
                <div className="border border-theme-secondary p-6 research-card transition-colors duration-300">
                  <h4 className="font-bold mb-2 text-xs mono-accent tracking-wider text-theme transition-colors duration-300">Relative Performance Focus</h4>
                  <p className="text-xs leading-relaxed font-light text-theme-secondary transition-colors duration-300">
          ...
          <section id="conclusion" className="mb-20 scroll-mt-20 technical-article-section">
            ...
            <div className="max-w-none">
              <div className="p-10 border-2 transition-colors duration-300" style={{ backgroundColor: "rgb(var(--bg-secondary))"
, borderColor: "rgb(var(--border-primary))", color: "rgb(var(--text-primary))" }}>
      ...
      <footer className="py-12 border-t-2 transition-colors duration-300" style={{ backgroundColor: "rgb(var(--bg-secondary))", borderColor: "rgb(var(--border-primary))", color: "rgb(var(--text-primary))" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs mono-accent text-center tracking-wider text-theme-muted transition-colors duration-300">
